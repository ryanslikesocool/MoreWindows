...
public extension Window {
	...
	init(_ title: Text, id: WindowID, @ViewBuilder content: @escaping () -> Content) {
	...
	///   - id: A unique ``WindowID`` that you can use to open the window.
	///   - content: The view content to display in the window.
	init(_ title: some StringProtocol, id: WindowID, @ViewBuilder content: @escaping () -> Content) {
		self.init(title, id: id.rawValue, content: content)
	}
	...
	///   - id: A unique ``WindowID`` that you can use to open the window.
	///   - content: The view content to display in the window.
	init(_ titleKey: LocalizedStringKey, id: WindowID, @ViewBuilder content: @escaping () -> Content) {
